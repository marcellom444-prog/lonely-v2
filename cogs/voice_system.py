...
=======
                "Only the owner can change the limit.",
>>>>>>> be79980 (Update Lonely bot)
                ephemeral=True,
            )
        try:
...
=======
                f"{interaction.user.mention} now owns this VC.",
>>>>>>> be79980 (Update Lonely bot)
                ephemeral=True,
            )
...
=======
            await interaction.followup.send("Added to TTS queue.", ephemeral=True)
>>>>>>> be79980 (Update Lonely bot)
        except RuntimeError as exc:
            await interaction.followup.send(f"❌ {exc}", ephemeral=True)
...
=======
        await interaction.response.send_message("TTS queue cleared.", ephemeral=True)
>>>>>>> be79980 (Update Lonely bot)
