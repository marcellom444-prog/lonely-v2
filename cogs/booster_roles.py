...
<<<<<<< HEAD
            return await ctx.send("You must be boosting this server to create a booster role.")
=======
...
<<<<<<< HEAD
        await ctx.send("✅ Booster role color updated.")
=======
...
>>>>>>> be79980 (Update Lonely bot)
    ...
    async def br_name(self, ctx: commands.Context, *, name: str):
        ...
        try:
            ...
            return await ctx.send("I can't edit that role. Move Lonely's role above it.")
<<<<<<< HEAD
        await ctx.send("✅ Booster role name updated.")
=======
...
<<<<<<< HEAD
        await ctx.send(f"✅ Shared {role.mention} with {member.mention}.")
=======
