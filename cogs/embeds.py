...
class Embeds(commands.Cog):
    ...
    async def create(self, interaction: discord.Interaction, name: str):
        ...
        await interaction.response.send_message(f"✅ Created embed `{name}`.", embed=discord.Embed.from_dict(data), ephemeral=True)
    ...
    async def show(self, interaction: discord.Interaction, name: str):
        ...
        if not d:
            return await interaction.response.send_message("That embed doesn't exist.", ephemeral=True)
